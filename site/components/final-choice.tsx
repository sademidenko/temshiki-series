    ...
    <div>
      <div className="choice">
        <article className="choice__branch reveal">
          <p className="choice__key">Команда 1 · контрключ Антона</p>
          <h3 className="choice__title">{finalChoice.burn.title}</h3>
          <p>{finalChoice.burn.text}</p>
        </article>
        <article className="choice__branch choice__branch--restore reveal">
          <p className="choice__key">Команда 2 · контрключ Антона</p>
          <h3 className="choice__title">{finalChoice.restore.title}</h3>
          <p>{finalChoice.restore.text}</p>
        </article>
      </div>
      <div className="choice__outcome reveal">
        <p className="choice__key">Один клик · 2026</p>
        <h3>{finalChoice.outcome}</h3>
